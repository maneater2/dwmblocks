...
- `sb-network`
- `sb-battery`\
All of these scripts can be found in my [dotfiles repo](/maneater2/files). Simply download each script (or add your own), make them each executable, and place them somewhere in your $PATH.
